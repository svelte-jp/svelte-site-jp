...
しかし、私たちはみなさんを待たせたままにしたくありませんでした。[プレビューサイト](https://svelte-5-preview.vercel.app)を作成し、新機能の詳細な説明と、インタラクティブな playground を用意しました。また、[Svelte Discord](https://svelte.dev/chat) の `#svelte-5-alpha` チャンネルでより詳しく学ぶこともできます。みなさんのフィードバックをお待ちしております！
