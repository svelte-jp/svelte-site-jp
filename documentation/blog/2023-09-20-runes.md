---
title: Rune 発表 (Introducing runes)
...
Svelte 5 では、_runes_ によって全てを変え、_ユニバーサルできめ細やかなリアクティビティ(universal, fine-grained reactivity)_ を実現します。
