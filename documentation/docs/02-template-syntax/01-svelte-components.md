...
### 1. `export` はコンポーネントの prop を作成する <!--1-export-creates-a-component-prop-->
...
### 2. 代入は 'リアクティブ' <!--2-assignments-are-reactive-->
...
### 3. `$:` はステートメントをリアクティブなものとしてマークする <!--3-$-marks-a-statement-as-reactive-->
...
### 4. store に `$` を付けるとその値にアクセスできる <!--4-prefix-stores-with-$-to-access-their-values-->
